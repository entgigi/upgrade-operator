...
func (e EntandoAppImages) FetchAppBuilder() string {
	k, _ := e[common.AppBuilderKey].(string)
	return k
}

func (e EntandoAppImages) FetchComponentManager() string {
	k, _ := e[common.ComponentManagerKey].(string)
	return k
}
...
var apps = EntandoAppList{
	"7.0.2": EntandoAppImages{
		...
		common.K8sService: "registry.hub.docker.com/entando/entando-k8s-service@sha256:d1e022d6c1eb1f20268372493115fb34066b52245995eee11b77b7c36bc66431",
		// "registry.hub.docker.com/entando/entando-k8s-plugin-controller:7.0.2"
		common.K8sPluginController: "registry.hub.docker.com/entando/entando-k8s-plugin-controller@sha256:8fa2a1f44ca9b94797bb5d65d409c58d924cabb60dada6bd2cb1a654adf605e3",
		// "registry.hub.docker.com/entando/entando-k8s-app-plugin-link-controller:7.0.2"
		common.K8sAppPluginLinkController: "registry.hub.docker.com/entando/entando-k8s-app-plugin-link-controller@sha256:bf71073f3e4d6c6815cbdc582a984695b5944cf3c82e603386a96bc0a1b4bd74",
	},
	"7.1.0": EntandoAppImages{
		...
		common.K8sService: "registry.hub.docker.com/entando/entando-k8s-service@sha256:d7f953ae5627f35a22ee1264e2017f8965b7db6df788a2d2d80e5be82eb7d52b",
		// "registry.hub.docker.com/entando/entando-k8s-plugin-controller:7.1.0"
		common.K8sPluginController: "registry.hub.docker.com/entando/entando-k8s-plugin-controller@sha256:fd58e7d59a20643735b9bbae6dac8d3b9f2f44c494c674ba13dd0bcc40bf66a9",
		// "registry.hub.docker.com/entando/entando-k8s-app-plugin-link-controller:7.1.0"
		common.K8sAppPluginLinkController: "registry.hub.docker.com/entando/entando-k8s-app-plugin-link-controller@sha256:d9e9cdcbf2abec4b0d1253955d4dffd01de284d32f40ac42ec18aa3e94e32db4",
	},
	"7.1.1": EntandoAppImages{
		...
		common.K8sService: "registry.hub.docker.com/entando/entando-k8s-service@sha256:df0473993a7eb6dd71fd06dcd3b31efebd470e9c9962fb2ccc85e6ee356de3cd",
		// "registry.hub.docker.com/entando/entando-k8s-plugin-controller:7.1.1"
		common.K8sPluginController: "registry.hub.docker.com/entando/entando-k8s-plugin-controller@sha256:1084d03bd9ecf2a720390b7e1543f60b43c4baa523b97a85e7e54590d81d2574",
		// "registry.hub.docker.com/entando/entando-k8s-app-plugin-link-controller:7.1.0"
		common.K8sAppPluginLinkController: "registry.hub.docker.com/entando/entando-k8s-app-plugin-link-controller@sha256:d9e9cdcbf2abec4b0d1253955d4dffd01de284d32f40ac42ec18aa3e94e32db4",
	},
}
...
func (r *ImageManager) FetchAndComposeImagesMap(entandoAppV2 v1alpha1.EntandoAppV2) EntandoAppImages {
	...
	if len(entandoAppV2.Spec.K8sService.ImageOverride) > 0 {
		images[common.K8sService] = entandoAppV2.Spec.K8sService.ImageOverride
	}
	if len(entandoAppV2.Spec.K8sPluginController.ImageOverride) > 0 {
		images[common.K8sPluginController] = entandoAppV2.Spec.K8sPluginController.ImageOverride
	}
	if len(entandoAppV2.Spec.K8sAppPluginLinkController.ImageOverride) > 0 {
		images[common.K8sAppPluginLinkController] = entandoAppV2.Spec.K8sAppPluginLinkController.ImageOverride
	}
